...
1. PhoneSnap for Windows starts a receiver that implements the local upload
   protocol. (`PROTOCOL.md` is on the unmerged `feature/cross-platform-capture`
   branch and is not part of `main`.)
